...
class Better_Messages_Mini_List
{
    ...
    public function html()
    {
        ...
        $friends = isset( Better_Messages()->script_variables['miniFriends'] ) && Better_Messages()->script_variables['miniFriends'];
        $groups  = isset( Better_Messages()->script_variables['miniGroups'] ) && Better_Messages()->script_variables['miniGroups'];
