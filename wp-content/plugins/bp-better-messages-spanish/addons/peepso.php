...
if ( !class_exists( 'Better_Messages_Peepso' ) ){
    ...
    class Better_Messages_Peepso
    {
        ...
        public function display_name_override( $display_name, $user_id ){
            if( $user_id === 0 ) return $display_name;
        ...
        public function disable_start_thread_for_non_friends(&$args, &$errors){
            ...
            foreach($recipients as $recipient){
                ...
                if( ! PeepSoFriendsModel::get_instance()->are_friends( Better_Messages()->functions->get_current_user_id(), $user->ID ) ) {
        ...
        public function member_buttons($options, $user_id)
        {
            ...
            $current_user = intval(Better_Messages()->functions->get_current_user_id());
        ...
        public function messages_list_popup(){
            ...
            $inbox_url = Better_Messages()->functions->get_user_messages_url( Better_Messages()->functions->get_current_user_id() );
            ob_start(); ?>
