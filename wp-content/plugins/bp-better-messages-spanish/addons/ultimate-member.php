...
if ( !class_exists( 'Better_Messages_Ultimate_Member' ) ){
    ...
    class Better_Messages_Ultimate_Member
    {
        ...
        public function __construct(){
            ...
            add_action('better_messages_rest_user_item', array( $this, 'um_user_info' ), 10, 3 );
        }
        ...
        public function um_pm_link( $args ){
            ...
            echo '<a href="' . $url . '" class="' . $link_class . '" target="_self" ' . $link_attr . '>' . __('Private Message', 'bp-better-messages') . '</a>';
            echo '</div>';
        }
