...
<div class="moppm_dollar">
	...
	<div id="pricing_feature_collection" class="moppm_pricing_feature_collection">
		<ul class="moppm_ul">
			...
			<li class="moppm_feature_collect moppm_available_feature"><span class="moppm_15_tooltip_methodlist"><i class="dashicons dashicons-saved moppm_check"></i><?php esc_html_e( 'Role Based 1 Click Reset All Password', 'password-policy-manager' ); ?><i class="dashicons dashicons-info moppm_info" aria-hidden="true"></i><span class="moppm_methodlist">One-click password reset will help you to reset all user’s passwords in just a single click in case of attack or any suspicious activity.</a></span></span></i></li>
...
<div>
	...
	<li><?php echo wp_kses( __( 'Click on <b>BUY</b> button above.', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	<li><?php echo wp_kses( __( ' You will be redirected to the miniOrange Console. Enter your miniOrange username and password, after which you will be redirected to the payment page.', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>

	<li><?php echo wp_kses( __( 'Select the number of sites you wish to upgrade for, and make the payment.', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	<li><?php echo wp_kses( __( 'After making the payment, you can find the Premium plugin to download from the <b>License</b> tab in the left navigation bar of the miniOrange Console.', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	<li><?php echo wp_kses( __( 'Download the paid plugin from the <b>Releases and Downloads</b> tab through miniOrange Console .', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	...
	<li><?php echo wp_kses( __( 'Login to the paid plugin with the miniOrange account you used to make the payment, after this you will be able to set the password policy settings', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	</ol>
</div>
<hr>
<div>
	...
	<ol class="moppm_licensing_plans_ol">
	<li><?php echo wp_kses( __( 'The plugin works with many Login page builder plugins (like Woocommerce/Ultimate member/User Registratin/Buddy press), however if you face any issues with your custom pages, contact us and we will help you with it.', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	<li><?php echo wp_kses( __( 'The <b>license key </b>is required to activate the <b>Premium</b> Plugin. You will have to login with the miniOrange Account you used to make the purchase then enter license key to activate plugin.', 'password-policy-manager' ), $moppm_allowed_html ); ?></li>
	</ol>
</div>
<hr><br>
<div>
	<?php echo '<b class="moppm_note">' . esc_html__( 'Refund Policy :', 'password-policy-manager' ) . '</b> <p style = "font-size:14px;">' . esc_html__( 'At miniOrange, we want to ensure you are 100% happy with your purchase. If the premium plugin you purchased is not working as advertised and you\'ve attempted to resolve any issues with our support team, which couldn\'t get resolved then we will refund the whole amount within 10 days of the purchase.', 'password-policy-manager' ) . ' </p>'; ?>
</div><br>
<hr><br>
<div>
...
<form class="moppm_display_none_forms" id="moppm_loginform" action="<?php echo esc_url( MOPPM_HOST_NAME ) . '/moas/login'; ?>" target="_blank" method="post">
<input type="hidden" name="username" value="<?php echo esc_attr( get_site_option( 'moppm_email' ) ); ?>" />
<input type="hidden" name="redirectUrl" value="<?php echo esc_url( MOPPM_HOST_NAME ) . '/moas/initializepayment'; ?>" />
