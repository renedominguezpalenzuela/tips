...
<h1><b><?php echo __('Integrations','password-policy-manager')?></b> </h1><br>
<span class="moppm_text"><?php echo __('We support most of the login forms in our premium plugin present on WordPress. And our plugin is tested with almost all the forms like Woocommerce, Ultimate Member, Elementor Pro, and so on ')?><?php echo '  <a href="'. esc_url_raw($upgrade_url) .'" style="color: red;">'; ?>[ UPGRADE ]</a></span><br><br>
        ...
        <table class="moppm_customloginform" style="width: 95%">
            <tr>
                ...
                <td style="align-items: right;">
                    <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_woocommerce_form" name="moppm_woocommerce_form">    
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_ultimete_member_form" name="moppm_ultimete_member_form">    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <?php echo '<img style="height:30px;width:30px;display: inline;"src="'.esc_url_raw($BuddyPress_logo).'">';?><h3 style="margin-left: 15px; font-size: large; display: inline; float: inherit; padding-right: 50px;">Buddypress</h3>
                </td>
                <td style="text-align: center;">
                    <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_Buddypress_form" name="moppm_Buddypress_form">    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                  <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_BBpress_form" name="moppm_BBpress_form" >    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                   <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_User_registration_form" name="moppm_User_registration_form" >    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                   <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_Member_Press_form" name="moppm_Member_Press_form" >    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                  <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_USer_pro_form" name="moppm_USer_pro_form" >    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center; ">
                   <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_Gravity_form" name="moppm_Gravity_form" >    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label> 
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center; ">
                   <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_Ninja_form" name="moppm_Ninja_form">    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align: center; ">
                  <label class="moppm_switch" >
                     <input type="checkbox"  id="moppm_Elementor_pro_form" name="moppm_Elementor_pro_form">    
                <span class="moppm_switch_slider moppm_switch_round mo_ppm_form_switch"></span>
                </label> 
                </td>
                <td>
