...
function moppm_reset_pass_form( $user ) {
	...
	<head>
		...
		<?php
		wp_enqueue_script( 'moppm_reset_pass_script', plugins_url( 'includes' . DIRECTORY_SEPARATOR . 'js' . DIRECTORY_SEPARATOR . 'jquery.min.js', __FILE__ ), array( 'jquery' ), MOPPM_VERSION, true );
