<?php
    ...
    $eventos = $data->calendar_last_events(30);
...
<div class="container-fluid">
    <div class="row py-3">
        <div class="col-lg-6 col-12 pb-lg-0 pb-5">
            <?php
                get_template_part('src/Blocks/ContenedorCalendario/views/content', 'contenedor-calendario-usuario', array('userID' => $currentUser));
            ?>
        </div>
        <div class="col-lg-6 col-12 mb-3 contenedor-eventos-calendario-user">
            ...
            ?>
                <div class="container-fluid mb-2 eventosUser-calendar-user" data-filter="<?php echo $evento['fechaFilter']; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-12">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end calendar-user-bottom">
                                <button class="btn btn-primary p-1 my-1 boton_pagination_cursos button-guardar-evento" type="button" data-user="<?php echo $currentUser; ?>" data-event="<?php echo $evento['ID']; ?>">Guardar</button>
            ...
            <?php
                endforeach;
            ?>
            <div class="row no-event-calendar-user">
                <div class="col-12">
                    <span class="d-block mx-auto tituloEvent-user">
