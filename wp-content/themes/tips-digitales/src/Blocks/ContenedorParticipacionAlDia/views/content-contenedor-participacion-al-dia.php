<?php
  $ancho = get_field('ancho_contenedor_participacion_al_dia');
  ...
  $tipo = get_field('tipo_contenedor');

?>
<div class="<?php echo $ancho; ?>">
  <div class="col-12 pb-4">
    <?php
      get_template_part('src/Blocks/ContenedorParticipacionAlDia/views/contenedor', $tipo);
    ?>
  </div>
</div>