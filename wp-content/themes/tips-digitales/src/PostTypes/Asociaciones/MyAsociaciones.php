...
class MyAsociaciones
{
    private $name       = 'Asociaciones';
    private $slug       = 'asociaciones';
    private $post_type  = 'asociaciones';
    ...
    public function add_post_type()
    {
        $labels = array(
            'name'                  => $this->name,
            'singular_name'         => __('Asociaciones', APP_TEXTDOMAIN),
            'menu_name'             => __('Asociaciones', APP_TEXTDOMAIN),
            'name_admin_bar'        => __('Asociaciones', APP_TEXTDOMAIN),
            'archives'              => __('Asociaciones archive', APP_TEXTDOMAIN),
            'attributes'            => __('Asociaciones attributes', APP_TEXTDOMAIN),
            'parent_item_colon'     => __('Parent Asociaciones:', APP_TEXTDOMAIN),
            'all_items'             => __('All Asociaciones', APP_TEXTDOMAIN),
            'add_new_item'          => __('Add new Asociaciones', APP_TEXTDOMAIN),
            'add_new'               => __('Add New', APP_TEXTDOMAIN),
            'new_item'              => __('New Asociaciones', APP_TEXTDOMAIN),
            'edit_item'             => __('Edit Asociaciones', APP_TEXTDOMAIN),
            'update_item'           => __('Update Asociaciones', APP_TEXTDOMAIN),
            'view_item'             => __('View Asociaciones', APP_TEXTDOMAIN),
            'view_items'            => __('View Asociaciones', APP_TEXTDOMAIN),
            'search_items'          => __('Search Asociaciones', APP_TEXTDOMAIN),
            'not_found'             => __('No Asociaciones found', APP_TEXTDOMAIN),
            'not_found_in_trash'    => __('No Asociaciones found in trash', APP_TEXTDOMAIN),
            ...
            'insert_into_item'      => __('Insert into Asociaciones', APP_TEXTDOMAIN),
            'uploaded_to_this_item' => __('Upload to this Asociaciones', APP_TEXTDOMAIN),
            'items_list'            => __('Asociaciones list', APP_TEXTDOMAIN),
            'items_list_navigation' => __('Asociaciones list navigation', APP_TEXTDOMAIN),
            'filter_items_list'     => __('Filter Asociaciones list', APP_TEXTDOMAIN),
        );
        $args = array(
            'label'                 => $this->name,
