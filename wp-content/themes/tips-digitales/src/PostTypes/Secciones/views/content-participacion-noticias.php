<?php
    ...
    $cantPosts = get_field('noticias_a_mostrar');
    ...
    <div class="row py-0">
        <div class="col-lg-8 col-12">
            <div class="d-flex ms-1 mt-2">
                ...
                <div class="col">
                    <h3 class="title-container-yoparticipoensalud px-2">Noticias</h3>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-outline col-md-12 pt-0 pb-3">
                        <input class="form-control border-end-0 border searchElement my-2" id="inputFiltroLocalidadNoticias" name='tags-localidad' value='' placeholder='Por localidad' data-tags='<?php echo json_encode($localidades->terms); ?>'>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="pt-0 pb-2">
            <div class="contenedorNoticias pt-2 pb-2">
                <div class="container-fluid">
                    <div class="row" id="isotopeGridParticipacionNoticias">
